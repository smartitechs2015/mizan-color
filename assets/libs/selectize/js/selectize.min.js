                    ...
                    ? ((l = r(a[0])),
                      l.length
                        ...
                        : 46 === f &&
                          void 0 !== l.start &&
                          (e =
                            e.substring(0, l.start) + e.substring(l.start + 1)))
                    : g &&
                      ((j = c.shiftKey),
  ...
  return (
    ...
    a.extend(w.prototype, {
      ...
      onKeyDown: function (a) {
        ...
        return (!b.isFull() && !b.isInputHidden) || (f ? a.metaKey : a.ctrlKey)
          ? void 0
      ...
      removeItem: function (b, c) {
        ...
        (d = b instanceof a ? b : g.getItem(b)),
          ...
          -1 !== (e = g.items.indexOf(b)) &&
            (d.remove(),
            d.hasClass("active") &&
              ((f = g.$activeItems.indexOf(d[0])), g.$activeItems.splice(f, 1)),
            g.items.splice(e, 1),
            (g.lastQuery = null),
            !g.settings.persist &&
      ...
      positionDropdown: function () {
        var a = this.$control,
          b =
            "body" === this.settings.dropdownParent ? a.offset() : a.position();
        ...
        e = function () {
          ...
          if (
            ...
            b.equalizeWidth &&
              ...
              (h = Math.round(j / f)),
              k.css({ width: h }),
              f > 1 && ((i = j - h * (f - 1)), k.eq(f - 1).css({ width: i })));
          }
        };
