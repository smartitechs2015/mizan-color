  ...
  (e.prototype.initSelect2 = function () {
    ...
    (e.prototype.initSelectize = function () {
      t("#selectize-tags").selectize({
        ...
        t(".select-car-number").selectize({
          sortField: "text",
          hideSelected: !1,
          plugins: { dropdown_header: { title: "رقم السيارة" } },
        });
        t(".select-driver-name").selectize({
            sortField: "text",
            hideSelected: !1,
            plugins: { dropdown_header: { title: "اسم السائق" } },
          });

          t(".select-package").selectize({
            sortField: "text",
            hideSelected: !1,
            plugins: { dropdown_header: { title: "مادة التحميل " } },
          });

          t(".select-client-name").selectize({
            sortField: "text",
            hideSelected: !1,
            plugins: { dropdown_header: { title: "اسم العميل" } },
          });
          t(".select-warehouse").selectize({
            sortField: "text",
            hideSelected: !1,
            plugins: { dropdown_header: { title: "مستودع التحميل" } },
          });
